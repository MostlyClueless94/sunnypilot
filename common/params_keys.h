...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"VehicleProfileCurrentKey", {CLEAR_ON_MANAGER_START, STRING}},
    {"VehicleProfileCurrentSource", {CLEAR_ON_MANAGER_START, STRING}},
    {"VehicleProfileLastAutoKey", {PERSISTENT, STRING}},
    {"VehicleProfiles", {PERSISTENT, JSON}},
