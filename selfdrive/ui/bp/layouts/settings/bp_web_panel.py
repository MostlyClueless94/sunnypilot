  ...
  def _render(self, rect):
    ...
    if not enabled:
      gui_label(
        ...
        "Enable the server above to access SubiPilot Portal",
...
class _HelpSection(Widget):
  """Shows SubiPilot Portal feature descriptions."""
...
class BPWebPanel(Widget):
  """SubiPilot web portal settings panel - ported from BP 5.0 QT panel.
