...
if gui_app.sunnypilot_ui():
  ...
  from openpilot.selfdrive.ui.sunnypilot.onroad.augmented_road_view import BORDER_COLORS_SP, AugmentedRoadViewSP, resolve_border_color
...
class AugmentedRoadView(CameraView, AugmentedRoadViewSP):
  def __init__(self, stream_type: VisionStreamType = VisionStreamType.VISION_STREAM_ROAD):
    ...
    self._set_placeholder_color(resolve_border_color(UIStatus.DISENGAGED, BORDER_COLORS))
    ...
    self._params = Params()
    self._confidence_ball = ConfidenceBallTiciSP() if gui_app.sunnypilot_ui() else None
    self._show_confidence_ball = _get_bool_param(self._params, "BPShowConfidenceBall")
  ...
  def _render(self, rect):
    ...
    ball_offset = (self._confidence_ball.BALL_WIDTH + BALL_BORDER_MARGIN) if self._show_confidence_ball and self._confidence_ball is not None else 0
    ...
    if self._show_confidence_ball and self._confidence_ball is not None:
      ball_strip_width = self._confidence_ball.BALL_WIDTH + BALL_BORDER_MARGIN
  ...
  def _draw_border(self, rect: rl.Rectangle):
    ...
    border_color = resolve_border_color(ui_state.status, BORDER_COLORS)
