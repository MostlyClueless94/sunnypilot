...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.BLUEPILOT: PanelInfo(tr_noop("SubiPilot"), BluePilotLayout(), icon="icons/chffr_wheel.png"),  # BluePilot: START/END - BP settings panel entry
      OP.PanelType.BP_PORTAL: PanelInfo(tr_noop("SubiPilot Portal"), BPWebPanel(), icon="icons/network.png"),  # BluePilot: BP Web Portal panel
    }
