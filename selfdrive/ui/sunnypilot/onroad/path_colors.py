...
STOCK_DYNAMIC_EDGE_COLORS = {
  UIStatus.DISENGAGED: vibrant_edge_color_from_gradient(
    STOCK_DYNAMIC_PATH_COLORS[UIStatus.DISENGAGED], STOCK_DYNAMIC_BORDER_COLORS[UIStatus.DISENGAGED],
  ),
  UIStatus.OVERRIDE: vibrant_edge_color_from_gradient(
    STOCK_DYNAMIC_PATH_COLORS[UIStatus.OVERRIDE], STOCK_DYNAMIC_BORDER_COLORS[UIStatus.OVERRIDE],
  ),
...
DEFAULT_PATH_EDGE_COLORS = {
  ...
  UIStatus.LAT_ONLY: CUSTOM_DYNAMIC_BORDER_COLORS[UIStatus.LAT_ONLY],
  UIStatus.LONG_ONLY: DEFAULT_GREEN_BORDER_COLOR,
  UIStatus.ENGAGED: DEFAULT_GREEN_BORDER_COLOR,
}
