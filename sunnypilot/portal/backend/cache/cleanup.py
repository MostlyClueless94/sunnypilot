#!/usr/bin/env python3
"""
SubiPilot Backend Cache Cleanup
...
from sunnypilot.portal.backend.config import REMUX_CACHE, ROUTES_DIR
...
def cleanup_old_cache():
    ...
    from sunnypilot.portal.backend.cache.metrics import get_cache_size
