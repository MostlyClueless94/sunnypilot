#!/usr/bin/env python3
"""
SubiPilot Backend Configuration
...
# Cache directories
DATA_ROOT = "/data/subipilot/portal/routes" if os.path.exists("/data") else os.path.expanduser("~/comma_data/subipilot/portal/routes")
...
# User preferences
SUBIPILOT_DATA_DIR = "/data/subipilot/portal" if os.path.exists("/data") else os.path.expanduser("~/comma_data/subipilot/portal")
FAVORITE_SETTINGS_FILE = os.path.join(SUBIPILOT_DATA_DIR, "favorite_settings.json")
