#!/usr/bin/env python3
"""
Log Download Handlers for SubiPilot Web Server
...
def generate_log_filename(route_base, log_type, segments=None):
    ...
    """
    from sunnypilot.portal.backend.config import METRICS_CACHE
...
def handle_qlog_download(handler, path, get_route_segments, server_state=None):
    ...
    try:
        ...
        from sunnypilot.portal.backend.config import IMPORT_TEMP_DIR
