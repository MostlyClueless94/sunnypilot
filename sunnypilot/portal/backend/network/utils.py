#!/usr/bin/env python3
"""
SubiPilot Backend Network Utilities
...
params = get_params_with_defaults({
    "IsOnRoad": False,
    "SubiPilotPortalPort": "8088",
    "SubiPilotPortalEnabled": False,
})
...
def should_server_run():
    ...
    try:
        return params.get_bool("SubiPilotPortalEnabled")
    except:
        return False  # Default closed if we can't check the explicit enable toggle.
