...
from sunnypilot.portal.backend.logs import parse_manager_log_line
    ...
    def _read_logs(self):
        ...
        try:
            while self.running:
                ...
                if formatted:
                    from sunnypilot.portal.backend.realtime.websocket import WebSocketEvent
