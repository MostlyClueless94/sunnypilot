...
from sunnypilot.portal.backend.routes.processing import (
    ROUTES_DIR,
    METRICS_CACHE,
    THUMBNAIL_CACHE,
...
from sunnypilot.portal.backend.routes.scanner import scan_routes
from sunnypilot.portal.backend.routes.segments import get_route_segments

# Import WebSocket broadcaster for cross-process communication
from sunnypilot.portal.backend.realtime import WebSocketBroadcaster
...
def main():
    ...
    logger.info("SubiPilot Route Preprocessor starting...")
    ...
    from sunnypilot.portal.backend.routes.processing import kill_existing_process
    kill_existing_process('sunnypilot.portal.backend.routes.preprocessor')
    ...
    try:
        web_port = int(params.get("SubiPilotPortalPort") or "8088")
    except:
        web_port = 8088
