...
export const useParamsStore = create<ParamsState>((set, get) => ({
  ...
  fetchParams: async () => {
    ...
    try {
      ...
      console.log("[SubiPilot] Fetched params:", paramCount, "parameters");

      // Debug: Log first param
      // const firstParam = Object.values(params)[0]
      // if (firstParam) {
      //   console.log('[SubiPilot] Sample param:', firstParam)
      //   console.log('[SubiPilot] Has type?', firstParam.type !== undefined)
      //   console.log('[SubiPilot] Has last_modified?', firstParam.last_modified !== undefined)
      // }
