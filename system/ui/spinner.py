...
class Spinner(Widget):
  def __init__(self):
    super().__init__()
    self._logo_texture = gui_app.texture("../../sunnypilot/selfdrive/assets/images/spinner_subipilot.png", TEXTURE_SIZE, TEXTURE_SIZE)
  ...
  def _render(self, rect: rl.Rectangle):
    ...
    # Draw rotating spinner and static center logo
